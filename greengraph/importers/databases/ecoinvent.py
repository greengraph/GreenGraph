...
class ecoinvent:
    r"""
    This class is a placeholder for the ecoinvent database importer.
    It is not intended to be used directly, but rather as a base class for
    specific ecoinvent importers.
    """
    ...
    def _prepare_ecoinvent_node_and_edge_lists(
        ...
        Warnings
        --------
        The EcoSpold parser in [`greengraph.importers.databases.ecoinvent._extract_ecospold_xml_files`][]
        uses a specific convention for production processes and the products they produce.
        In this convention, products are represented as nodes in the graph:
        ...
        using the `product_to_process` mapping:
